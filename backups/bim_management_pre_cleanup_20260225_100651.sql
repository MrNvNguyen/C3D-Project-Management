...
INSERT INTO _cf_METADATA VALUES(2,26362);
CREATE TABLE users (
  id INTEGER PRIMARY KEY AUTOINCREMENT,
...
INSERT INTO projects VALUES(91,'C08','Trụ sở 123',NULL,'Cục---123','building','planning','2026-02-24',NULL,0.0,6000000000.0,NULL,5,2,0,1,'2026-02-24 04:26:55','2026-02-24 04:26:55');
INSERT INTO projects VALUES(116,'111','111123','','1456','infrastructure','planning','2026-02-26','',0.0,1.0,'',5,NULL,0,1,'2026-02-24 04:31:02','2026-02-24 09:27:40');
...
INSERT INTO categories VALUES(6,116,'Kiến trúc Nhà làm việc chính','NLV-AA','','','basic_design','2026-02-25','',0,'pending',NULL,1,'2026-02-24 08:09:43','2026-02-24 09:27:52');
CREATE TABLE tasks (
  id INTEGER PRIMARY KEY AUTOINCREMENT,
  project_id INTEGER NOT NULL,
  category_id INTEGER,
...
INSERT INTO tasks VALUES(56,2,4,'123','12345','ZZ','construction_design','medium','completed',4,4,'2026-02-24',NULL,NULL,'2026-02-24',30.0,0.0,100,0,NULL,NULL,'2026-02-24 04:09:46','2026-02-24 12:37:46');
INSERT INTO tasks VALUES(92,3,5,'qqqq','','ZZ','technical_design','high','completed',NULL,1,'2026-02-24','2026-02-28',NULL,'2026-02-25',30.0,0.0,100,0,NULL,NULL,'2026-02-24 04:17:26','2026-02-25 09:08:47');
INSERT INTO tasks VALUES(258,116,NULL,'Thiết kế mặt đứng công trình 123','','ZZ','basic_design','medium','completed',NULL,3,'2026-02-24','2026-02-25',NULL,'2026-02-25',10.0,0.0,100,0,NULL,NULL,'2026-02-24 04:46:46','2026-02-25 09:08:36');
...
INSERT INTO task_history VALUES(1,56,4,'created',NULL,'Task created',NULL,'2026-02-24 04:09:46');
INSERT INTO task_history VALUES(2,92,1,'created',NULL,'Task created',NULL,'2026-02-24 04:17:26');
INSERT INTO task_history VALUES(7,258,3,'created',NULL,'Task created',NULL,'2026-02-24 04:46:46');
INSERT INTO task_history VALUES(8,258,1,'description','','',NULL,'2026-02-24 09:28:53');
INSERT INTO task_history VALUES(9,258,1,'assigned_to','','1',NULL,'2026-02-24 09:28:53');
INSERT INTO task_history VALUES(10,258,1,'estimated_hours','0','10',NULL,'2026-02-24 09:29:08');
INSERT INTO task_history VALUES(11,258,1,'due_date','','2026-02-25',NULL,'2026-02-24 09:29:19');
INSERT INTO task_history VALUES(12,258,1,'status','todo','in_progress',NULL,'2026-02-24 09:29:48');
INSERT INTO task_history VALUES(13,56,4,'progress','0','100',NULL,'2026-02-24 12:37:38');
INSERT INTO task_history VALUES(14,56,4,'status','todo','completed',NULL,'2026-02-24 12:37:46');
...
INSERT INTO task_history VALUES(18,258,1,'status','in_progress','completed',NULL,'2026-02-25 09:08:36');
INSERT INTO task_history VALUES(19,258,1,'assigned_to','1','null',NULL,'2026-02-25 09:08:36');
INSERT INTO task_history VALUES(20,258,1,'progress','0','100',NULL,'2026-02-25 09:08:36');
INSERT INTO task_history VALUES(21,92,1,'description','','',NULL,'2026-02-25 09:08:47');
INSERT INTO task_history VALUES(22,92,1,'status','todo','completed',NULL,'2026-02-25 09:08:47');
INSERT INTO task_history VALUES(23,92,1,'assigned_to','4','null',NULL,'2026-02-25 09:08:47');
INSERT INTO task_history VALUES(24,92,1,'progress','0','100',NULL,'2026-02-25 09:08:47');
...
INSERT INTO timesheets VALUES(2868,4,3,92,'2026-02-24',8.0,4.0,NULL,'approved',4,'2026-02-24 12:38:11','2026-02-24 12:38:04','2026-02-24 12:38:11');
INSERT INTO timesheets VALUES(2869,4,2,56,'2026-02-24',8.0,0.0,NULL,'approved',4,'2026-02-24 12:45:01','2026-02-24 12:38:39','2026-02-24 12:45:01');
...
INSERT INTO project_revenues VALUES(246,91,'Thanh toán đợt 1',45000000.0,'VND',NULL,NULL,'pending',NULL,1,'2026-02-24 13:41:59','2026-02-24 13:41:59');
...
INSERT INTO notifications VALUES(1,2,'Task sắp đến hạn','Task "Vẽ mặt bằng tầng điển hình" còn 3 ngày đến hạn','warning','task',1,1,'2026-02-24 03:34:42');
INSERT INTO notifications VALUES(2,3,'Task được giao mới','Bạn được giao task "Thiết kế khung thép tầng 1"','info','task',4,1,'2026-02-24 03:34:42');
INSERT INTO notifications VALUES(3,4,'Báo cáo timesheet chờ duyệt','3 timesheet đang chờ phê duyệt','info','task',NULL,1,'2026-02-24 03:34:42');
INSERT INTO notifications VALUES(4,4,'Task mới được giao','Bạn được giao task: 123','info','task',56,1,'2026-02-24 04:09:46');
INSERT INTO notifications VALUES(5,2,'Bạn đã được thêm vào dự án','Bạn đã được thêm vào dự án với vai trò member','info','project',1,1,'2026-02-24 04:13:27');
INSERT INTO notifications VALUES(6,3,'Bạn đã được thêm vào dự án','Bạn đã được thêm vào dự án với vai trò member','info','project',1,1,'2026-02-24 04:13:32');
INSERT INTO notifications VALUES(7,4,'Bạn đã được thêm vào dự án','Bạn đã được thêm vào dự án với vai trò project_leader','info','project',1,1,'2026-02-24 04:13:39');
INSERT INTO notifications VALUES(8,5,'Bạn đã được thêm vào dự án','Bạn đã được thêm vào dự án với vai trò project_admin','info','project',1,1,'2026-02-24 04:13:45');
INSERT INTO notifications VALUES(9,4,'Bạn đã được thêm vào dự án','Bạn đã được thêm vào dự án với vai trò project_leader','info','project',2,1,'2026-02-24 04:14:03');
INSERT INTO notifications VALUES(10,3,'Bạn đã được thêm vào dự án','Bạn đã được thêm vào dự án với vai trò member','info','project',2,1,'2026-02-24 04:14:10');
INSERT INTO notifications VALUES(11,2,'Bạn đã được thêm vào dự án','Bạn đã được thêm vào dự án với vai trò member','info','project',2,1,'2026-02-24 04:14:18');
INSERT INTO notifications VALUES(12,5,'Bạn đã được thêm vào dự án','Bạn đã được thêm vào dự án với vai trò project_admin','info','project',2,1,'2026-02-24 04:14:23');
INSERT INTO notifications VALUES(13,2,'Bạn đã được thêm vào dự án','Bạn đã được thêm vào dự án với vai trò member','info','project',3,1,'2026-02-24 04:14:40');
INSERT INTO notifications VALUES(14,3,'Bạn đã được thêm vào dự án','Bạn đã được thêm vào dự án với vai trò member','info','project',3,1,'2026-02-24 04:14:47');
INSERT INTO notifications VALUES(15,4,'Bạn đã được thêm vào dự án','Bạn đã được thêm vào dự án với vai trò project_leader','info','project',3,1,'2026-02-24 04:14:55');
INSERT INTO notifications VALUES(16,5,'Bạn đã được thêm vào dự án','Bạn đã được thêm vào dự án với vai trò project_admin','info','project',3,1,'2026-02-24 04:15:02');
INSERT INTO notifications VALUES(17,4,'Task mới được giao','Bạn được giao task: qqqq','info','task',92,1,'2026-02-24 04:17:26');
...
INSERT INTO sqlite_sequence VALUES('disciplines',3096);
...
INSERT INTO sqlite_sequence VALUES('cost_types',365);
